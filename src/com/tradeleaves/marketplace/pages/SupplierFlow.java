...
public class SupplierFlow 
{
	...
	//Go through Supplier user registration, Company Registration, Subscription & Product posting for US site
		public void doUICheckforSupplierFlow() throws BiffException, ClassNotFoundException, IOException, InterruptedException, SQLException, AWTException, FindFailed
		{
